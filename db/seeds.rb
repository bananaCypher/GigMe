User.create!([
  ...
  {email: "gigger1@email.com", encrypted_password: "$2a$10$ftq5ZyEBVWhB0aJTnXKZ4eaXOAeKkkyQSfezNPCrAy/AtqBDWs0.u", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 4, current_sign_in_at: "2016-01-10 12:06:29", last_sign_in_at: "2016-01-09 17:31:39", current_sign_in_ip: "::1", last_sign_in_ip: "::1", role: nil},
  {email: "gigger2@email.com", encrypted_password: "$2a$10$dPkJrTLtqP9iXcY7GG9apuEiyEbIdahDUmZQ4tS131pvhn6ZWU6ZW", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 3, current_sign_in_at: "2016-01-09 18:07:33", last_sign_in_at: "2016-01-09 17:32:48", current_sign_in_ip: "::1", last_sign_in_ip: "::1", role: nil},
  {email: "gigger3@email.com", encrypted_password: "$2a$10$uzAW5JeONBrk8volSsFbYug57gOAsg.mZdSRnFv6gmYlDG.ceK69a", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2016-01-08 20:44:06", last_sign_in_at: "2016-01-08 20:44:06", current_sign_in_ip: "::1", last_sign_in_ip: "::1", role: nil}
])
Act.create!([
...
Act::HABTM_Keywords.create!([
  ...
  {act_id: 2, keyword_id: 11},
  {act_id: 1, keyword_id: 2},
  {act_id: 1, keyword_id: 7},
  {act_id: 1, keyword_id: 8}
])
Gig.create!([
  {price: "45.0", start_time: "2016-01-16 19:00:00", end_time: "2016-01-16 21:00:00", capacity: 20000, act_id: 1, venue_id: 7},
  {price: "35.5", start_time: "2016-01-23 19:00:00", end_time: "2016-01-10 21:30:00", capacity: 10000, act_id: 2, venue_id: 6},
  {price: "50.0", start_time: "2016-01-16 19:30:00", end_time: "2016-01-10 22:00:00", capacity: 6000, act_id: 3, venue_id: 8}
])
Keyword.create!([
